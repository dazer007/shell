...
docker build -t hub.c.163.com/dazer1992/yuebaoxiao:0.01 .

docker push hub.c.163.com/dazer1992/yuebaoxiao:0.01

#以交互方式运行一个镜像，运行完成之后，直接删除掉容器; 注意端口 【外部映射端口：内部端口】
#docker run -it --rm -p 8881:8881 hub.c.163.com/dazer1992/yuebaoxiao:0.01
